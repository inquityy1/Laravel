            ...
            <div class="card-body">
              ...
              <form class="p-4 p-md-5" action="{{ route('store.jobs') }}" method="post" enctype="multipart/form-data">
                ...
                @if($errors->has('vacancy'))
                  <p class="alert alert-success">{{ $errors->first('vacancy') }}</p>
                @endif
                ...
                @if($errors->has('other_benefits'))
                  <p class="alert alert-success">{{ $errors->first('other_benefits') }}</p>
                @endif
                ...
                @if($errors->has('category'))
                  <p class="alert alert-success">{{ $errors->first('category') }}</p>
                @endif
